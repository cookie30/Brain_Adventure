...
public class PlayerMove : MonoBehaviour
{
    ...
    private void MovePlayer()
    {
        ...
        // 如果不在地面，則移動速度還可以乘上一個在空中的加乘數字，可以製造人物一跳往上飛的超人飛行效果
            ...
            rbFirstPerson.AddForce(moveDirection.normalized * moveSpeed  * airMultiplier, ForceMode.Force);
    }
    ...
    private void OnCollisionEnter(Collision collision)
    {
        if (collision.gameObject.tag == "Monster1")
        {
            ...
            gameManager.m_HPBar.fillAmount -= hpAmount/hpMax;
        }
        else if (collision.gameObject.tag == "Monster2")
        {
